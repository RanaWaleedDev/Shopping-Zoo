package com.android.paws.Admin;
...
public class NewProductActivity extends AppCompatActivity {
    String[] categoriesList = {"Select Category", "Services", "Products", "Adoption", "Food"};
    String[] brandsList = {"Select Brand Name", "Nutra", "Paws", "Tech", "Tez"};
